...
# 1 "/usr/lib/gcc/x86_64-redhat-linux/6.3.1/include/stddef.h" 1 3 4
# 216 "/usr/lib/gcc/x86_64-redhat-linux/6.3.1/include/stddef.h" 3 4
...
# 1 "/usr/lib/gcc/x86_64-redhat-linux/6.3.1/include/stdarg.h" 1 3 4
# 40 "/usr/lib/gcc/x86_64-redhat-linux/6.3.1/include/stdarg.h" 3 4
...
# 1 "/usr/lib/gcc/x86_64-redhat-linux/6.3.1/include/stddef.h" 1 3 4
# 328 "/usr/lib/gcc/x86_64-redhat-linux/6.3.1/include/stddef.h" 3 4
typedef int wchar_t;
...
# 9 "tac.c" 2
# 22 "tac.c"
IR_Tac_Add_instr_t IR_Tac_Add_instr_new(char *x, char *y, char *z) { IR_Tac_Add_instr_t p = malloc(sizeof(*p)); p->kind = IR_TAC_KIND_ADD; p->x = x; p->y = y; p->z = z; return IR_Tac_Add_instr_t }
IR_Tac_Minus_instr_t IR_Tac_Minus_instr_new(char *x, char *y, char *z) { IR_Tac_Minus_instr_t p = malloc(sizeof(*p)); p->kind = IR_TAC_KIND_MINUS; p->x = x; p->y = y; p->z = z; return IR_Tac_Minus_instr_t }
IR_Tac_Mul_instr_t IR_Tac_Mul_instr_new(char *x, char *y, char *z) { IR_Tac_Mul_instr_t p = malloc(sizeof(*p)); p->kind = IR_TAC_KIND_MUL; p->x = x; p->y = y; p->z = z; return IR_Tac_Mul_instr_t }
IR_Tac_Div_instr_t IR_Tac_Div_instr_new(char *x, char *y, char *z) { IR_Tac_Div_instr_t p = malloc(sizeof(*p)); p->kind = IR_TAC_KIND_DIV; p->x = x; p->y = y; p->z = z; return IR_Tac_Div_instr_t }
IR_Tac_And_instr_t IR_Tac_And_instr_new(char *x, char *y, char *z) { IR_Tac_And_instr_t p = malloc(sizeof(*p)); p->kind = IR_TAC_KIND_AND; p->x = x; p->y = y; p->z = z; return IR_Tac_And_instr_t }
IR_Tac_Or_instr_t IR_Tac_Or_instr_new(char *x, char *y, char *z) { IR_Tac_Or_instr_t p = malloc(sizeof(*p)); p->kind = IR_TAC_KIND_OR; p->x = x; p->y = y; p->z = z; return IR_Tac_Or_instr_t }
